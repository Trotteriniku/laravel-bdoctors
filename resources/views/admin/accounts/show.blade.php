    ...
    <div class="container mt-4 pt-5" style="background-color: #f6f9ff;">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <h1 class="card-title fw-semibold ">Informazioni Utente</h1>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <h1 class="card-title fw-semibold ">Messaggi Ricevuti</h1>
                ...
                <div class="card mb-4 ">
                    <div class="card-body">
                        <h1 class="card-title fw-semibold ">Specializzazioni</h1>
